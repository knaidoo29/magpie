...
def usphere_rotate(phi, theta, phi_end, theta_end, phi_start=0.,
    ...
    x_start, y_start, z_start \
        = conversions.sphere2cart(r_start, phi_start, theta_start)
    u = np.array([x_start, y_start, z_start])
    # determine vector of end point but first convert to cartesian coordinates
    x_end, y_end, z_end = conversions.sphere2cart(r_start, phi_end, theta_end)
    ...
    # convert points on the sphere to cartesian coordinates
    x, y, z = conversions.sphere2cart(r, phi, theta)
    ...
    r_new, phi_new, theta_new = conversions.cart2sphere(x_new, y_new, z_new)
